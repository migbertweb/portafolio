<div>
    <div class="text-center lg:p-14 p-4">
    ...
    <div
        class="text-5xl flex justify-center gap-16 py-3 ">

        <a href="https://www.linkedin.com/in/migbert-yanez-cana" target="_blank">
            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024"
                class="w-12 h-12 md:w-16 md:h-16 lg:w-20 lg:h-20 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-500" xmlns="http://www.w3.org/2000/svg">
                <path
