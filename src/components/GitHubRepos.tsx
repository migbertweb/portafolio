...
import { Star, GitFork, ExternalLink, Cpu, Code, Server } from 'lucide-react';

const repositories = [
  {
    name: 'django_crud_react',
    description: 'CRUD com API Django como Backend e Frontend em React',
    language: 'Python',
  ...
  },
  {
    ...
    description: 'Monitoramento IoT com ESP32-C3, dashboard web em tempo real, WebSocket e MQTT',
    language: 'C',
  ...
  },
  {
    ...
    description: 'Projeto IoT com sensor DHT11 e display OLED – ESP-IDF',
    language: 'C',
    languageColor: '#555555',
    stars: 0,
    forks: 0,
  ...
  },
  {
    ...
    description: 'Cluster Kubernetes K3S provisionado com Terraform na Hetzner',
    language: 'HCL',
  ...
  {
    name: 'argocd-ksops',
    description: 'GitOps com ArgoCD + SOPS para gestão segura de secrets em Kubernetes',
    language: 'Shell',
  ...
  },
  {
    ...
    description: 'Proxy reverso Traefik com geração automática de certificados SSL via Let\'s Encrypt',
    language: 'Dockerfile',
    languageColor: '#384d54',
    stars: 0,
    forks: 0,
    url: 'https://github.com/migbertweb/traefik-cert-manager',
    icon: Server,
  },
];
